...
export class CmsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.cmsAuthService.getPermission().subscribe(permissionObject => {
      ...
      const uprawnienia3 = [4, 5, 6, 7, 19, 20, 21, 34, 35, 36, 49, 64, 65, 66, 79, 94, 112];
      const uprawnienia4 = [15, 16, 17, 18, 19, 20, 21, 45, 46, 47, 49, 75, 76, 77, 79, 105, 112];
      const uprawnienia5 = [30, 31, 32, 33, 34, 35, 36, 45, 46, 47, 49, 90, 91, 92, 94, 105, 112];
      const uprawnienia6 = [60, 61, 62, 63, 64, 65, 66, 75, 76, 77, 79, 90, 91, 92, 94, 105, 112];
